...
MBS テレビで放映されている[プレバト](https://www.mbs.jp/p-battle/)が好きでよく見ているのですが、この TV 番組は 2012 年から放送されているかなりの長寿番組であるということを知り、俳句のアプリで何かおもしろいものを作りたいなと考えたのがきっかけです
...
section backend
CRUD-controller: 2022-06-01,30d
auth: 3d
JWT: 2d
error-handling: 4d
others & debug: 20d
...
外部からのアクセスに関しては認証のミドルウェアがある為、ある程度は拒否できるようにし、ログインした後のアクセスに関しては、そのアカウント当事者以外の重要な情報はレスポンスで返さない、インジェクション対策を取るなどしています。
...
勉学の中心はバックエンドに関わる内容を中心に、フロントエンドの JS フレームワークも覚えていきたいと考えています

現在勉強している分野

### SQL

SQL を 現在 Udemy で学習しています。業務では SQL を使うことが多いと聞くので Node.js 上で MySQL と連携したアプリも作ってみたいと考えておりますが、現状 Node.js で MySQL との連携は一部うまく動作しないところがあり、少し不安を覚えています
例えば、
...
mongoDB も非常に面白い DB でまた Node.js でも使いやすいと思います。
...
それ以降プログラミングを主体的に勉強しようと思ったことが何度かありましたがどれも数週間で勉強をやめてしまった覚えがあります。

自分にはプログラミンの才能がないと思った時期もありましたが、現在このように毎日楽しくプログラミングをすることができ、転職も考えるようになるまで至ったことには自分でも驚くばかりです
